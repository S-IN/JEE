...
// --------------------------------------------------------------------------
   public void lire(Contact contact) throws ParserConfigurationException,
                                            SAXException,
                                            IOException
   {
      int rowCount;
...
// --------------------------------------------------------------------------
   public int creer(Contact contact) throws ParserConfigurationException,
                                            SAXException,
                                            IOException
   {
      int rowCount;
...
// --------------------------------------------------------------------------
   public int modifier(Contact contact) throws ParserConfigurationException,
                                               SAXException,
                                               IOException
   {
      int rowCount;
...
// --------------------------------------------------------------------------
   public int detruire(Contact contact) throws ParserConfigurationException,
                                               SAXException,
                                               IOException
   {
      int rowCount;
